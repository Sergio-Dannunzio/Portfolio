    ...
    <>
      <div className="flex flex-col items-center bg-[#17171790] p-7 rounded-2xl border border-[#262626] max-w-[580px] w-full  h-fit">
        ...
        <div className="flex w-full mt-4">
          <button className="bg-[#8b99f8] hover:bg-[#8b99f8]/80 rounded-2xl p-3 w-1/2 mr-2 items-center flex justify-center text-[#000000] cursor-pointer"><p className="pr-2 text-2xl"
